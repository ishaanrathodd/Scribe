...
final class DashboardStatsSnapshotStore: @unchecked Sendable {
    ...
    private let logger = Logger(subsystem: "com.prakashjoshipax.scribe", category: "DashboardStatsSnapshotStore")
    private let fileManager: FileManager
    private let userDefaults: UserDefaults
    private let snapshotURL: URL
    private let saveQueue = DispatchQueue(
        label: "com.prakashjoshipax.scribe.dashboardStatsSnapshotStore", qos: .utility)
