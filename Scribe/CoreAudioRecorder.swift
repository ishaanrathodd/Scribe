...
final class CoreAudioRecorder: @unchecked Sendable {
    ...
    private let logger = Logger(subsystem: "com.prakashjoshipax.scribe", category: "CoreAudioRecorder")
    ...
    private let audioProcessingQueue = DispatchQueue(
        label: "com.prakashjoshipax.scribe.audioProcessing", qos: .userInitiated)
