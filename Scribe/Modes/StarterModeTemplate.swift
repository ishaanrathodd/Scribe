...
enum StarterModeCatalog {
    static let templates: [StarterModeTemplate] = [
        ...
        StarterModeTemplate(
            ...
            guidance:
                "Use this after selecting relevant text or opening the related window. Scribe uses that context to shape a clear email draft.",
        ...
        StarterModeTemplate(
            ...
            guidance:
                "Use this for answers, summaries, and follow-ups. Instead of pasting, Scribe keeps the conversation inside the recorder.",
