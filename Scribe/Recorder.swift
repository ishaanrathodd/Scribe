...
class Recorder: NSObject, ObservableObject {
    ...
    let logger = Logger(subsystem: "com.prakashjoshipax.scribe", category: "Recorder")
    ...
    let audioSetupQueue = DispatchQueue(label: "com.prakashjoshipax.scribe.audioSetup", qos: .userInitiated)
