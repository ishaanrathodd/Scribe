...
class ImportExportService {
    ...
    func exportSettings(
        ...
        do {
            ...
            savePanel.nameFieldStringValue = "Scribe_Settings_Backup.json"
            savePanel.title = String(localized: "Export Scribe Settings")
    ...
    func importSettings(
        ...
        openPanel.title = String(localized: "Import Scribe Settings")
    ...
    private func showImportSuccessAlert(message: String, needsAPIKeyReminder: Bool) {
        DispatchQueue.main.async {
            ...
            informativeText +=
                "\n\n" + String(localized: "It is recommended to restart Scribe for all changes to take full effect.")
